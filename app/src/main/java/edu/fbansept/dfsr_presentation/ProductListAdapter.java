...
public class ProductListAdapter extends RecyclerView.Adapter<ProductListAdapter.ProductViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        holder.itemProductTitle.setText(productList.get(position).getAnime_name());
        holder.itemProductDescription.setImageBitmap(this.getBitmapFromURL(productList.get(position).getAnime_img()));
